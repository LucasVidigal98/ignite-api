...
var _IStorageProvider = require("@shared/providers/StorageProvider/IStorageProvider");
var _dec, _dec2, _dec3, _dec4, _dec5, _class;
let UpdateUserAvatarUseCase = (_dec = (0, _tsyringe.injectable)(), _dec2 = function (target, key) {
  return (0, _tsyringe.inject)("UserRepository")(target, undefined, 0);
}, _dec3 = function (target, key) {
  return (0, _tsyringe.inject)('LocalStorageProvider')(target, undefined, 1);
  ...
  async execute({
    ...
    if (user.avatar) await this.storageProvider.delete('avatar', user.avatar);
